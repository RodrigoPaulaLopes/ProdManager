...
import com.rodrigo.ProdManager.dtos.ClienteEmailDTO;
...
public class AutenticacaoResource {
    ...
    @PostMapping("/forgot")
    public ResponseEntity<Void> forgot(@Valid @RequestBody ClienteEmailDTO dados) throws MessagingException {
        userAuthenticatedService.sendNewPassword(dados.email());
        return ResponseEntity.noContent().build();
    }
}
